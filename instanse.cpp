...
{
    urlRepo = "http://drsaha.hopto.org/repo/mc/" + nameInst + "/";
...
void Instanse::startRun()
{
    ...
    QList<QString> args2 = {
        ...
        "-Dminecraft.client.jar="+CD+"/versions/Forge " + this->instanseMC + "/Forge_1.7.10.jar",
        "-cp",
        ...
        +CD+"/versions/Forge " + this->instanseMC + "/Forge_1.7.10.jar",
    ...
    args << "-Xmx768M"
         ...
         << "-Dfml.ignorePatchDiscrepancies=true"
         << "-Djava.net.useSystemProxies=true"
         << "-Djava.library.path=" + CD + "/versions/Forge 1.12.2/natives"
         << "-cp"
         << CD + "/libraries/net/minecraftforge/forge/1.12.2-14.23.5.2811/forge-1.12.2-14.23.5.2811.jar;"
              + CD + "/libraries/net/minecraft/launchwrapper/1.12/launchwrapper-1.12.jar;"
              ...
              + CD + "/versions/Forge 1.12.2/Forge 1.12.2.jar"
